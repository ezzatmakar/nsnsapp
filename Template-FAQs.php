        ...
        <div class="container">
            <div class="col-xs-12">
                <div class="title">
                    ...
                    <h1><?php the_title(); ?></h1><img class="rightIcon"
                                                       src="<?php echo get_template_directory_uri(); ?>/img/ns.svg">
                </div>
            </div>
        </div>
        <div class="container v-center">
                    ...
                    if ($faqs->have_posts()) {
                        while ($faqs->have_posts()) {
                            ...
                            <div id="collapse<?php echo $i; ?>"
                                 class="panel-collapse collapse <?php echo ($i == 1) ? 'in' : ''; ?>" role="tabpanel"
            ...
            <div class="col-sm-5 col-sm-offset-1 col-xs-12  col-image">
                <div class="imageWarp v-bottom">
                    <img class="w100" src="<?php echo get_the_post_thumbnail_url(); ?>">
                </div>
            </div>
        </div>
    </section>
